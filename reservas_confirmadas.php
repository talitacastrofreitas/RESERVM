  ...
  <div class="col-lg-12">
    <div class="card">
      ...
      <div class="card-body p-0">
        ...
        -- FILTROS DE STATUS (APENAS RESERVADOS)
        WHERE ss.solic_sta_status = 4
        
        -- AQUI MUDAMOS OS NOMES DOS PARÂMETROS
        AND (
            solicitacao.solic_cad_por = :user_id1 
            OR 
            EXISTS (
                SELECT 1 
...
// PASSAMOS O MESMO VALOR DUAS VEZES
$stmt->execute([
    ':user_id1' => $user_id_logado, 
    ':user_id2' => $user_id_logado
]);
