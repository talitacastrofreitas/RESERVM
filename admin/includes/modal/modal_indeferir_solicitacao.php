<div class="modal fade modal_padrao" id="modal_indeferir_solicitacao" tabindex="-1"
  aria-labelledby="modalIndeferirsolicitacao" aria-modal="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="../router/web.php?r=AprovaAnaliseAdmin" class="needs-validation"
          id="ValidaBotaoProgressIndeferir" novalidate>
          ...
          <div class="row g-3">
            ...
            <div class="col-12">
              <div>
                ...
                <textarea class="form-control" name="sta_an_obs" id="" rows="10" required>[Informe o motivo]
                Caso tenha dúvidas ou deseje mais informações, entre em contato com a Equipe de Suporte ao Ensino.
