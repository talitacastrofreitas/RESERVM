...
if (!isset($_SESSION['admin_id_cript_pass'])) {
...
<div class="row justify-content-center align-items-center flex-column">
  <div class="card card_login">
    <div class="card-body px-3 px-sm-4 py-4">
      ...
      <form class="needs-validation" method="POST" action="../router/web.php?r=updPass&func=upd_pass" id="UserRegistro" novalidate>

        <input type="hidden" class="form-control" value="<?= htmlspecialchars($_SESSION['admin_id_cript_pass']) ?>" name="cod" required>
        ...
        <div class="mt-4">
          <button type="submit" class="btn botao botao_verde_musgo waves-effect waves-light w-100">Cadastrar</button>
        </div>
