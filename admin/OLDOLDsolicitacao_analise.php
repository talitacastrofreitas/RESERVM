          ...
          <div class="col-lg-12">
            ...
            <div class="tab-content text-muted">
              <div class="tab-pane active" id="dados_solicitacao" role="tabpanel">
                                  ...
                                  <div class="row grid gx-3 mb-2">
                                    ...
                                    <?php if ($solic_ap_tipo_material == 1) { ?>
                                      ...
                                      <div class="col-12" id="file_ancora">
                                        <div class="mb-4">
                                          <label class="form-label">Formulário de planejamento de atividades de práticas nos
                                            ...
                                            while ($arq = $sql->fetch(PDO::FETCH_ASSOC)) {
                                              ...
                                              <div class="result_file">
                                                <div class="result_file_name p-1"><a
                                                    ...
                                                    target="_blank"><?= $arq['sarq_arquivo'] ?></a></div>
                                              </div>
                                            <?php } ?>
                                    ...
                                    <?php } else { ?>
                                      ...
                                      <div class="col-12">
                                        <div class="mb-4">
                                          <label class="form-label">Descreva os materiais, insumos e equipamentos, com suas
                                            respectivas quantidades, que serão necessários para a realização da aula no
                              ...
                              <div id="accor_fill2" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body">
                                  ...
                                  <div class="row grid gx-3">
                                    ...
                                    <div class="col-md-6 col-xl-4 col-xxl-3">
                                      <div class="mb-3">
                                        <label class="form-label">Quantidade de sala(s) / laboratório(s) de
                                          informática</label>
                    ...
                    <div class="card-header" style="background: var(--azul_alpha);">
                      <div class="row align-items-center">
                        <div class="col-12 tit_nova_solicitacao">
                          <h3 class="m-0 fs-16" style="color: var(--preto);">Informações da Reserva <span
                              class="fs-12 ms-2"
                    ...
                    <div class="card-body p-4">
                      <div class="row grid gx-3">
                        ...
                        <div class="col-12 <?= empty($solic_ap_quant_material) ? 'd-none' : '' ?>">
                          <label>Descreva os materiais, insumos e equipamentos, com suas respectivas quantidades, que
                            serão necessários para a realização da aula no espaço de prática</label>
                ...
                <?php include 'includes/modal/modal_reservas.php'; // Este include traz o HTML dos modais, mas vamos gerenciar os listeners aqui. ?>
                      ...
                      <div class="card-header" style="background: #0B3132;">
                        <div class="row align-items-center">
                          ...
                          <div
                            ...
                            <div class="btn botao botao_amarelo waves-effect mt-3 mt-md-0" data-bs-toggle="modal"
                              data-bs-toggle="button" data-bs-target="#modal_cad_espaco">+ Cadastrar Reserva</div>
                          </div>
                        </div>
                      </div>
                              ...
                              try {
                                ...
                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                  ...
                                  <tr>
                                    ...
                                    <td scope="row" nowrap="nowrap"><strong><?= htmlspecialchars($solic_codigo) ?></strong>
                                    </td>
                                    ...
                                    <td class="text-end d-flex flex-row">
                                      <a class="btn btn_soft_azul btn-sm me-2" data-bs-toggle="modal"
                                        ...
                                        data-bs-res_dia_semana="<?= $res_dia_semana ?>" data-bs-res_mes="<?= $res_mes ?>"
                                        ...
                                        data-bs-res_turno="<?= $res_turno ?>" title="Editar"><i
                        ...
                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                          ...
                          <div class="line_time acitivity-item pb-3 d-flex">
                            ...
                            <div class="flex-grow-1 ms-3">
                              ...
                              <h6 class="mb-1">
                                <?= date("d/m/Y H:i", strtotime($sta_an_data_upd)) . ' ' . $primeiroNome . '&nbsp;' . $ultimoNome ?>
                              </h6>
                    ...
                    <div class="row align-items-center">
                      ...
                      <div
                        ...
                        <button class="btn botao botao_amarelo waves-effect mt-3 mt-sm-0" data-bs-toggle="modal"
                          data-bs-toggle="button" data-bs-target="#modal_cad_ocorrencia">+ Cadastrar Ocorrência</button>
                      </div>
                    </div>
                  </div>
...
<script>
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    async function checkTimeConflict(contextModalId) {
                        ...
                        if (!currentModal) {
                            console.error(`Modal ${contextModalId} não encontrado para checkTimeConflict.`);
                            return;
                        }
                        ...
                        if (!currentData || !currentInicio || !currentFim) {
                            console.error(`Erro: Um ou mais campos de data/hora não foram encontrados no modal ${contextModalId}.`);
                            return;
                        }
                        ...
                        if (dataValue && inicioValue && fimValue && (localCabulaValue || localBrotasValue)) {
                            try {
                                ...
                                Swal.fire('Erro', 'Ocorreu um erro ao verificar conflitos de horário. Por favor, tente novamente.', 'error');
                            }
                        }
                    }

                    // Função para verificar a capacidade do espaço
                    async function checkCapacity(selectedSpaceId, numPeopleValue, mode = 'change') {
                        if (!selectedSpaceId || numPeopleValue === '' || numPeopleValue === null) {
                            console.log('checkCapacity: selectedSpaceId ou numPeopleValue ausente/inválido. Pulando verificação.');
                            return true; // Permite prosseguir
                        }

                        const numPeopleInt = parseInt(numPeopleValue);
                        if (isNaN(numPeopleInt) || numPeopleInt <= 0) {
                             console.warn('checkCapacity: Número de pessoas inválido ou zero. Ignorando alerta.');
                             return true; // Permite prosseguir se o número for inválido ou zero, sem alertar
                        }

                        try {
                            // Fetch a capacidade máxima do espaço do servidor
                            console.log(`checkCapacity: Buscando capacidade para space_id=${selectedSpaceId}`);
                            const response = await fetch(`get_space_capacity.php?space_id=${selectedSpaceId}`);
                            
                            if (!response.ok) {
                                console.error(`checkCapacity: Erro HTTP na resposta: ${response.status} - ${response.statusText}`);
                            ...
                            console.log('checkCapacity: Resposta do servidor:', data);
                            ...
                            if (data.success && data.max_capacity !== null) {
                                ...
                                if (numPeopleInt > maxCapacity) {
                                    if (mode === 'change') {
                                        ...
                                        return true; // No modo 'change', apenas alerta, não impede a digitação
                                    } else if (mode === 'submit') {
                                        ...
                                        return result.isConfirmed; // Retorna true se 'Sim, continuar' for clicado
                                    }
                                }
                            } else {
                                console.warn(`checkCapacity: get_space_capacity.php não retornou dados de capacidade válidos para o espaço ${selectedSpaceId} (success: ${data.success}, max_capacity: ${data.max_capacity}). Prosseguindo.`);
                            }
                            return true; // Se não houver excesso de capacidade ou problemas de dados, permite prosseguir
                        } catch (error) {
                            console.error('checkCapacity: Erro ao buscar a capacidade do espaço:', error);
                            Swal.fire('Erro', 'Ocorreu um erro ao verificar a capacidade do espaço. Por favor, tente novamente.', 'error');
                            return false; // Impede o envio do formulário em caso de erro na requisição
                        }
                    }

                    // Função auxiliar para obter o ID do espaço selecionado no modal atual
                    function getSelectedSpaceId(modalElement) {
                        // Prioriza IDs específicos do modal de CADASTRO
                        ...
                        // Prioriza IDs específicos do modal de EDIÇÃO
                        ...
                        return null; // Nenhum espaço selecionado
                    }

                    // --- INÍCIO DA LÓGICA PARA MODAIS (Cadastro e Edição) ---
                    // Conecta listeners APENAS quando o modal é mostrado para garantir que os elementos existem.
                    if (modalCadReserva) {
                        modalCadReserva.addEventListener('shown.bs.modal', function () {
                            ...
                            const cadCapacMaximaInput = this.querySelector("#esp_quant_maxima"); // ID ORIGINAL

                            if (formCadReserva && cadNumPessoasInput) {
                                // Handler para quando o número de pessoas OU o local selecionado muda
                                const handleCadCapacityCheck = async () => {
                                    console.log('handleCadCapacityCheck acionado.');
                                    const selectedSpaceId = getSelectedSpaceId(modalCadReserva);
                                    console.log('ID do espaço selecionado (CAD):', selectedSpaceId);
                                    console.log('Valor Nº Pessoas (CAD):', cadNumPessoasInput.value);

                                    await checkCapacity(selectedSpaceId, cadNumPessoasInput.value, 'change');
                                    
                                    // Atualiza o campo de Capac. Máxima também
                                    if (selectedSpaceId && cadCapacMaximaInput) {
                                        try {
                                            ...
                                            console.error('Erro ao atualizar campo Capac. Máxima (CAD):', error);
                                            cadCapacMaximaInput.value = 'Erro';
                                        }
                                    }
                                };

                                // Limpa listeners anteriores para evitar duplicação em reaberturas do modal
                                ...
                                formCadReserva.removeEventListener('submit', formSubmitHandler); // Remove para evitar duplicidade
                                ...
                                // Chamada inicial para garantir que a capacidade máxima seja exibida ao abrir o modal, se um local já estiver selecionado.
                                handleCadCapacityCheck();
                            }

                            // Listeners para verificação de conflito de horário
                            ...
                            // Limpa e adiciona listeners de conflito de horário
                            if (cadDataInput) { cadDataInput.removeEventListener("change", () => checkTimeConflict('modal_cad_espaco')); cadDataInput.addEventListener("change", () => checkTimeConflict('modal_cad_espaco')); }
                            if (cadInicioInput) { cadInicioInput.removeEventListener("change", () => checkTimeConflict('modal_cad_espaco')); cadInicioInput.addEventListener("change", () => checkTimeConflict('modal_cad_espaco')); }
                            if (cadFimInput) { cadFimInput.removeEventListener("change", () => checkTimeConflict('modal_cad_espaco')); cadFimInput.addEventListener("change", () => checkTimeConflict('modal_cad_espaco')); }
                        });
                    }
                    ...
                    if (modalEditReserva) {
                        modalEditReserva.addEventListener('shown.bs.modal', function () {
                            ...
                            const editCapacMaximaInput = this.querySelector("#edit_reserva_camp_maximo"); // ID ORIGINAL

                            if (formEditReserva && editNumPessoasInput) {
                                // Handler para quando o número de pessoas OU o local selecionado muda
                                const handleEditCapacityCheck = async () => {
                                    console.log('handleEditCapacityCheck acionado.');
                                    const selectedSpaceId = getSelectedSpaceId(modalEditReserva);
                                    console.log('ID do espaço selecionado (EDIT):', selectedSpaceId);
                                    console.log('Valor Nº Pessoas (EDIT):', editNumPessoasInput.value);
                                    ...
                                    if (selectedSpaceId && editCapacMaximaInput) {
                                        try {
                                            ...
                                            console.error('Erro ao atualizar campo Capac. Máxima (EDIT):', error);
                                ...
                                formEditReserva.removeEventListener('submit', editFormSubmitHandler); // Remove para evitar duplicidade
                            ...
                            // Limpa e adiciona listeners de conflito de horário
                            if (editDataInput) { editDataInput.removeEventListener("change", () => checkTimeConflict('modal_edit_espaco')); editDataInput.addEventListener("change", () => checkTimeConflict('modal_edit_espaco')); }
                            if (editInicioInput) { editInicioInput.removeEventListener("change", () => checkTimeConflict('modal_edit_espaco')); editInicioInput.addEventListener("change", () => checkTimeConflict('modal_edit_espaco')); }
                            if (editFimInput) { editFimInput.removeEventListener("change", () => checkTimeConflict('modal_edit_espaco')); editFimInput.addEventListener("change", () => checkTimeConflict('modal_edit_espaco')); }
                        });
                        
                        // Resetar para etapa 0 ao abrir o modal de edição (este bloco já estava no seu modal_reservas.php, mantive aqui)
                        // Removi o bloco de script que estava no final do modal_reservas.php pois a lógica de evento shown.bs.modal está aqui.
                        // Seu código de preencherCamposEdit e as funções de etapa/validação do modal_reservas.php devem ser mantidos.
                    }
                    // --- Lógica para Seleção/Exclusão de Reservas (fora dos modais) ---
                    const marcarTodos = document.getElementById('marcarTodos');
                    const checkboxes = document.querySelectorAll('.checkbox');
                    const btnExcluir = document.getElementById('btnExcluirSelecionados');
                    const formExcluirSelecionados = document.getElementById('formExcluirSelecionados');

                    if (marcarTodos && checkboxes.length > 0 && btnExcluir && formExcluirSelecionados) {
                        function atualizarBotaoExcluir() {
                            const algumMarcado = document.querySelectorAll('.checkbox:checked').length > 0;
                            btnExcluir.style.display = algumMarcado ? 'inline-block' : 'none';
                        }
