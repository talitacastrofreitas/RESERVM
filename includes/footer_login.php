<footer class="footer_user mt-auto">
  <div class="row justify-content-center">
    <div class="col-lg-12 col-xl-9">
      <img src="assets/images/logo_bahiana_login.svg" alt="">
      <p class="mt-2 text-light">&copy; <script>
          document.write(new Date().getFullYear())
        </script> RESERVM - Sistema de Reserva de Espaço Bahiana. Todos os direitos reservados.</p>
    </div>
  </div>
</footer>
</div>
