  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header modal_padrao_vermelho">
        <h5 class="modal-title" id="modalIndeferirsolicitacao">Indeferir Solicitação</h5>
        <button type="button" class="btn-close-modal" data-bs-dismiss="modal" aria-label="Close"><i class="fa-solid fa-xmark"></i></button>
      </div>
      <div class="modal-body">
        <form method="POST" action="router/web.php?r=AprovaAnalise" class="needs-validation" id="ValidaBotaoProgressIndeferir" novalidate>
