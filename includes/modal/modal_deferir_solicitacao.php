  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header modal_padrao_cinza">
        <h5 class="modal-title" id="modal_deferir_solicitacao">Aprovar Solicitação</h5>
        <button type="button" class="btn-close-modal" data-bs-dismiss="modal" aria-label="Close"><i class="fa-solid fa-xmark"></i></button>
      </div>
      <div class="modal-body">
        <form method="POST" action="router/web.php?r=AprovaAnalise" class="needs-validation" id="ValidaBotaoProgressDeferir" novalidate>
          ...
          <div class="row g-3">
            ...
            <div class="col-12">
              <div>
                ...
                <textarea class="form-control" name="sta_an_obs" rows="10"></textarea>
              </div>
            </div>
            ...
            <div class="col-lg-12">
              <div class="hstack gap-3 align-items-center justify-content-end mt-2">
                ...
                <button type="submit" class="btn botao botao_verde waves-effect">Aprovar</button>
              </div>
            </div>
