<div class="card-body p-sm-4 p-3">
  ...
  <form class="needs-validation" method="POST" action="controller/controller_propostas.php" id="validaCheckbox" autocomplete="off" novalidate>
    ...
    <div class="row grid gx-3">
      ...
      <div class="col-12">
        <div class="mb-3">
          ...
          <input type="text" class="form-control text-uppercase" name="prop_titulo" value="<?= $prop_titulo ?>" maxlength="215" required>
      ...
      <div class="col-12 mb-3">
        <div class="form-check">
          <input class="form-check-input" type="checkbox" id="prop_vinculo_programa" name="prop_vinculo_programa" value="1" <?php echo ($prop_vinculo_programa == 1) ? 'checked' : ''; ?>>
      ...
      <div class="col-12" id="campo_vinculo_programa" style="display: none;">
        <div class="mb-3">
          ...
          <textarea class="form-control" name="prop_qual_vinculo_programa" id="prop_qual_vinculo_programa" rows="3"><?= str_replace('<br />', '', $prop_qual_vinculo_programa) ?></textarea>
          <div class="invalid-feedback">Este campo é obrigatório</div>
        </div>
      </div>
      ...
      <script>
        ...
        if (prop_vinculo_programa.checked) {
          campo_vinculo_programa.style.display = "block"; // Mostrar o campo de entrada
          document.getElementById('prop_qual_vinculo_programa').required = true;
        }
      </script>
      ...
      <div class="col-12">
        <div class="mb-3">
          ...
          <textarea class="form-control" name="prop_descricao" rows="3" required><?= str_replace('<br />', '', $prop_descricao) ?></textarea>
          <div class="invalid-feedback">Este campo é obrigatório</div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="mb-3">
          ...
          <select class="form-select" name="prop_curso_vinculo" id="prop_curso_vinculo" required>
            <option selected value="<?= $cc_id  ?>"><?= $cc_curso ?></option>
      ...
      <div class="col-md-6 col-lg-8" id="campo_prop_nome_curso_vinculo" style="display: none;">
        <div class="mb-3">
          ...
          <input type="text" class="form-control text-uppercase" name="prop_nome_curso_vinculo" id="prop_nome_curso_vinculo" value="<?= $prop_nome_curso_vinculo ?>">
          <div class="invalid-feedback">Este campo é obrigatório</div>
        </div>
      </div>
    ...
    <div class="row grid gx-3">
      ...
      <div class="col-12">
        <div class="mb-3">
          ...
          <textarea class="form-control" name="prop_justificativa" rows="3" required><?= str_replace('<br />', '', $prop_justificativa) ?></textarea>
          <div class="invalid-feedback">Este campo é obrigatório</div>
        </div>
      </div>
    ...
    <div class="row grid gx-3">
      ...
      <div class="col-12">
        <div class="mb-3">
          ...
          <textarea class="form-control" name="prop_obj_pedagogico" rows="3" required><?= str_replace('<br />', '', $prop_obj_pedagogico) ?></textarea>
          <div class="invalid-feedback">Este campo é obrigatório</div>
        </div>
      </div>
    ...
    <div class="row grid gx-3">
      ...
      <div class="col-12">
        <div class="mb-3">
          ...
          <textarea class="form-control" name="prop_publico_alvo" rows="3" required><?= str_replace('<br />', '', $prop_publico_alvo) ?></textarea>
          <div class="invalid-feedback">Este campo é obrigatório</div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-12 mb-3">
        ...
        <div class="check_item_container">
          <?php
          $area = explode(",", $prop_area_conhecimento);
          ...
          while ($ac = $sql->fetch(PDO::FETCH_ASSOC)) {
            if (in_array($ac['ac_id'], $area)) {
              $prop_area_conhecimento_checked = "checked";
            } else {
              $prop_area_conhecimento_checked = "";
            }
          ?>
            <input type="checkbox" class="btn-check" name="prop_area_conhecimento[]" id="checkConhecimento<?= $ac['ac_id'] ?>" value="<?= $ac['ac_id'] ?>" <?= $prop_area_conhecimento_checked ?>>
            <label class="btn btn-outline-primary check_item" for="checkConhecimento<?= $ac['ac_id'] ?>"><?= $ac['ac_area_conhecimento'] ?></label>
          <?php } ?>
          <div id="msgCheckConhecimento" class="invalid-feedback" style="display: none;">Selecione pelo menos uma opção</div>
        </div>
      </div>
      <script>
        // VALIDA CHECKBOX
        document
          .getElementById("validaCheckbox")
          .addEventListener("submit", function(event) {
            var checkboxConhecimento = document.querySelectorAll('input[name="prop_area_conhecimento[]"]');
            var checked = false;

            checkboxConhecimento.forEach(function(checkbox) {
              if (checkbox.checked) {
                checked = true;
              }
            });
            ...
            if (!checked) {
              var msgCheckConhecimento = document.getElementById("msgCheckConhecimento");
              msgCheckConhecimento.style.display = "block";
              event.preventDefault(); // Impede o envio do formulário
            }
          });

        // Adicionar um evento de mudança para apagar a mensagem de erro quando um checkbox é marcado
        var checkboxConhecimento = document.querySelectorAll('input[name="prop_area_conhecimento[]"]');
        checkboxConhecimento.forEach(function(checkbox) {
          checkbox.addEventListener("change", function() {
            ...
            var checked = false;
            checkboxConhecimento.forEach(function(cb) {
              if (cb.checked) {
                checked = true;
              }
            });
            ...
            if (checked) {
              msgCheckConhecimento.style.display = "none";
            } else {
              msgCheckConhecimento.style.display = "block";
            }
          });
    ...
    <div class="row">
      <div class="col-12 mb-3">
        ...
        <div class="check_item_container">
          <?php
          $area = explode(",", $prop_area_tematica);
          $sql = $conn->query("SELECT at_id, at_area_tematica FROM conf_areas_tematicas ORDER BY at_area_tematica");
          while ($at = $sql->fetch(PDO::FETCH_ASSOC)) {
            if (in_array($at['at_id'], $area)) {
              $prop_area_tematica_checked = "checked";
            } else {
              $prop_area_tematica_checked = "";
            }
          ?>
            <input type="checkbox" class="btn-check" name="prop_area_tematica[]" id="check<?= $at['at_id'] ?>" value="<?= $at['at_id'] ?>" <?= $prop_area_tematica_checked ?>>
            <label class="btn btn-outline-primary check_item" for="check<?= $at['at_id'] ?>"><?= $at['at_area_tematica'] ?></label>
          <?php } ?>
          <div id="msgCheckATematica" class="invalid-feedback" style="display: none;">Selecione pelo menos uma opção</div>
        </div>
      </div>
      <script>
        // VALIDA CHECKBOX
        document
          .getElementById("validaCheckbox")
          .addEventListener("submit", function(event) {
            var checkboxATematica = document.querySelectorAll('input[name="prop_area_tematica[]"]');
            var checked = false;

            checkboxATematica.forEach(function(checkbox) {
              if (checkbox.checked) {
                checked = true;
              }
            });
            ...
            if (!checked) {
              var msgCheckATematica = document.getElementById("msgCheckATematica");
              msgCheckATematica.style.display = "block";
              event.preventDefault(); // Impede o envio do formulário
            }
          });
        ...
        checkboxATematica.forEach(function(checkbox) {
          checkbox.addEventListener("change", function() {
            ...
            // Verifica novamente se pelo menos um checkbox está marcado
            var checked = false;
            checkboxATematica.forEach(function(cb) {
              if (cb.checked) {
                checked = true;
              }
            });
            ...
            if (checked) {
              msgCheckATematica.style.display = "none";
            } else {
              msgCheckATematica.style.display = "block";
            }
          });
    ...
    <div class="row grid gx-3">
      <div class="col-12 mb-3">
        ...
        <div class="check_item_container">
          <?php
          $dias = explode(",", $prop_semana);
          $sql = $conn->query("SELECT week_id, week_dias FROM dias_semana ORDER BY week_id");
          while ($week = $sql->fetch(PDO::FETCH_ASSOC)) {
            if (in_array($week['week_id'], $dias)) {
              $prop_semana_checked = "checked";
            } else {
              $prop_semana_checked = "";
            }
          ?>
            <input type="checkbox" class="btn-check" name="prop_semana[]" id="checkSemana<?= $week['week_id'] ?>" value="<?= $week['week_id'] ?>" <?= $prop_semana_checked ?>>
            <label class="btn btn-outline-primary check_item" for="checkSemana<?= $week['week_id'] ?>"><?= $week['week_dias'] ?></label>
          <?php } ?>
          <div id="msgCheckDSemana" class="invalid-feedback" style="display: none;">Selecione pelo menos uma opção</div>
        </div>
      </div>
      <script>
        // VALIDA CHECKBOX
        document
          .getElementById("validaCheckbox")
          .addEventListener("submit", function(event) {
            var checkboxDSemana = document.querySelectorAll('input[name="prop_semana[]"]');
            var checked = false;

            checkboxDSemana.forEach(function(checkbox) {
              if (checkbox.checked) {
                checked = true;
              }
            });
            ...
            if (!checked) {
              var msgCheckDSemana = document.getElementById("msgCheckDSemana");
              msgCheckDSemana.style.display = "block";
              event.preventDefault(); // Impede o envio do formulário
            }
          });
        ...
        checkboxDSemana.forEach(function(checkbox) {
          checkbox.addEventListener("change", function() {
            ...
            // Verifica novamente se pelo menos um checkbox está marcado
            var checked = false;
            checkboxDSemana.forEach(function(cb) {
              if (cb.checked) {
                checked = true;
              }
            });
            ...
            if (checked) {
              msgCheckDSemana.style.display = "none";
            } else {
              msgCheckDSemana.style.display = "block";
            }
          });
      ...
      <div class="col-12">
        <div class="mb-3">
          ...
          <textarea class="form-control" name="prop_horario" rows="3" required><?= str_replace('<br />', '', $prop_horario) ?></textarea>
          <div class="invalid-feedback">Este campo é obrigatório</div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4 col-xl-3 col-xxl-2">
        <div class="mb-3">
          ...
          <input type="date" class="form-control" name="prop_data_inicio" id="prop_data_inicio" value="<?= $prop_data_inicio ?>" onblur="checkDateInicio()" required>
          <div class="invalid-feedback">Este campo é obrigatório</div>
        </div>
        <script>
      ...
      <div class="col-md-6 col-lg-4 col-xl-3 col-xxl-2">
        <div class="mb-3">
          ...
          <input type="date" class="form-control" name="prop_data_fim" id="prop_data_fim" value="<?= $prop_data_fim ?>" onblur="checkDateFinal()" required>
          <div class="invalid-feedback">Este campo é obrigatório</div>
        </div>
        <script>
      ...
      <div class="col-md-6 col-lg-4 col-xl-3 col-xxl-2">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="prop_carga_hora" value="<?= $prop_carga_hora ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="10" placeholder="Horas" required>
          <div class="invalid-feedback">Este campo é obrigatório</div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4 col-xl-3 col-xxl-2">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="prop_total_vaga" value="<?= $prop_total_vaga ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="10" required>
          <div class="invalid-feedback">Este campo é obrigatório</div>
        </div>
      </div>
      ...
      if (in_array(base64_decode($_GET['tp']), $cat_propostas)) { ?>
        <div class="col-md-6 col-lg-4 col-xl-3 col-xxl-2">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="prop_quant_turma" value="<?= $prop_quant_turma ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="10" required>
            <div class="invalid-feedback">Este campo é obrigatório</div>
          </div>
        </div>
      <?php } ?>
      ...
      <div class="col-md-6 col-lg-4 col-xl-3 col-xxl-2">
        <div class="mb-3">
          ...
          <select class="form-select text-uppercase" name="prop_modalidade" id="prop_modalidade" required>
            <option selected value="<?= $mod_en_id ?>"><?= $mod_en_modalidade ?></option>
      ...
      <div class="col-md-6 col-lg-4 col-xl-3 col-xxl-2" id="campo_prop_campus" style="display: none;">
        <div class="mb-3">
          ...
          <select class="form-select text-uppercase" name="prop_campus" id="prop_campus">
            <option selected value="<?= $uni_id ?>"><?= $uni_unidade ?></option>
            <?php foreach ($result_itens as $result_iten) : ?>
      ...
      <div class="col-md-6 col-lg-4 col-xl-3 col-xxl-2" id="campo_prop_local" style="display: none;">
        <div class="mb-3">
          ...
          <input type="text" class="form-control text-uppercase" name="prop_local" id="prop_local" value="<?= $prop_local ?>" maxlength="100">
          <div class="invalid-feedback">Este campo é obrigatório</div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4 col-xl-3 col-xxl-2">
        <div class="mb-3">
          ...
          <select class="form-select text-uppercase" name="prop_forma_acesso" id="prop_forma_acesso" required>
            <option selected value="<?= $for_acess_id ?>"><?= $for_acess_forma_acesso ?></option>
            <?php foreach ($result_itens as $result_iten) : ?>
      ...
      <div class="col-md-6 col-lg-4 col-xl-3 col-xxl-2" id="campo_prop_preco" style="display: none;">
        <div class="mb-3">
          ...
          <input type="text" class="form-control money" name="prop_preco" value="<?= $prop_preco ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="10" placeholder="R$">
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4 col-xl-3 col-xxl-2" id="campo_prop_preco_parcelas" style="display: none;">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="prop_preco_parcelas" value="<?= $prop_preco_parcelas ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="10">
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4 col-xl-3 col-xxl-4" id="campo_prop_outra_forma_acesso" style="display: none;">
        <div class="mb-3">
          ...
          <input type="text" class="form-control text-uppercase" name="prop_outra_forma_acesso" id="prop_outra_forma_acesso" value="<?= $prop_outra_forma_acesso ?>" maxlength="50">
          <div class="invalid-feedback">Este campo é obrigatório</div>
        </div>
      </div>
    ...
    <div class="row grid gx-3">
      ...
      <div class="col-12 mb-2">
        <div class="form-check">
          <input class="form-check-input" type="checkbox" name="prop_acao_acessibilidade" id="prop_acao_acessibilidade" value="1" <?php echo ($prop_acao_acessibilidade == 1) ? 'checked' : ''; ?>>
      ...
      <div class="col-12 mt-2" id="campo_prop_desc_acao_acessibilidade" style="display: none;">
        <div class="mb-4">
          ...
          <textarea class="form-control" name="prop_desc_acao_acessibilidade" id="prop_desc_acao_acessibilidade" rows="3"><?= str_replace('<br />', '', $prop_desc_acao_acessibilidade) ?></textarea>
          <div class="invalid-feedback">Este campo é obrigatório</div>
        </div>
        <script>
      ...
      <div class="col-12 mb-2">
        <div class="form-check">
          <input class="form-check-input" type="checkbox" id="prop_ofertas_vagas" name="prop_ofertas_vagas" value="1" <?php echo ($prop_ofertas_vagas == 1) ? 'checked' : ''; ?>>
      ...
      <div class="col-md-6 col-lg-4 col-xl-3 col-xxl-2 mt-2" id="campo_prop_quant_beneficios" style="display: none;">
        <div class="mb-4">
          ...
          <input type="text" class="form-control" name="prop_quant_beneficios" id="prop_quant_beneficios" value="<?= $prop_quant_beneficios ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="10">
          <div class="invalid-feedback">Este campo é obrigatório</div>
        </div>
        <script>
          // MOSTRA CAMPO QUANDO CLICAR NO CHECKBOX
      ...
      <div class="col-12 mb-3">
        <div class="form-check">
          <input class="form-check-input" type="checkbox" id="prop_atendimento_doacao" name="prop_atendimento_doacao" value="1" <?php echo ($prop_atendimento_doacao == 1) ? 'checked' : ''; ?>>
      ...
      <div id="campo_atendimentos" style="display: none;">
        ...
        <div class="col-12">
          <div class="mb-3">
            ...
            <textarea class="form-control" name="prop_desc_beneficios" id="prop_desc_beneficios" rows="3"><?= str_replace('<br />', '', $prop_desc_beneficios) ?></textarea>
            <div class="invalid-feedback">Este campo é obrigatório</div>
          </div>
        </div>
        ...
        <div class="col-12">
          <div class="mb-3">
            ...
            <textarea class="form-control" name="prop_comunidade" id="prop_comunidade" rows="3"><?= str_replace('<br />', '', $prop_comunidade) ?></textarea>
            <div class="invalid-feedback">Este campo é obrigatório</div>
          </div>
        </div>
        ...
        <div class="col-12">
          <div class="mb-3">
            ...
            <textarea class="form-control" name="prop_localidade" id="prop_localidade" rows="3"><?= str_replace('<br />', '', $prop_localidade) ?></textarea>
            <div class="invalid-feedback">Este campo é obrigatório</div>
          </div>
        </div>
        ...
        <div class="col-12">
          <div class="mb-3">
            ...
            <textarea class="form-control" name="prop_responsavel" id="prop_responsavel" rows="3"><?= str_replace('<br />', '', $prop_responsavel) ?></textarea>
            <div class="invalid-feedback">Este campo é obrigatório</div>
          </div>
        </div>
        ...
        <div class="col-12">
          <div class="mb-3">
            ...
            <textarea class="form-control" name="prop_responsavel_contato" id="prop_responsavel_contato" rows="3"><?= str_replace('<br />', '', $prop_responsavel_contato) ?></textarea>
            <div class="invalid-feedback">Este campo é obrigatório</div>
          </div>
        </div>
    ...
    <div class="row grid gx-3">
      <div class="col-12">
        <div class="mb-3">
          ...
          <textarea class="form-control" name="prop_info_complementar" id="" rows="3"><?= str_replace('<br />', '', $prop_info_complementar) ?></textarea>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-12">
      <div class="hstack gap-3 align-items-center justify-content-end mt-4">
        ...
        <?php if ($prop_sta_status < 7) { ?>
          <button type="submit" class="btn botao botao_verde waves-effect" name="EditProposta">Próximo</button>
        <?php } else { ?>
