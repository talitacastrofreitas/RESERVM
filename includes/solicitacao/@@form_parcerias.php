...
<!-- ValidaBotaoProgressPadrao -->
<form class="needs-validation meuFormulario form_solicitacao" method="POST" action="cad_proposta.php?tp=NA==" id="" enctype="multipart/form-data" autocomplete="off" novalidate>
          ...
          <div id="campo_info_pratic_data_reserva" style="display: none;">
            ...
            <div class="col-12" id="campo_info_pratic_dias_semana" style="display: none;">
              <div class="form_margem">
                ...
                <div class="check_container">
                  <div class="form-check form_solicita">
                    <input class="form-check-input form_solicita me-2" type="checkbox" name="cad_info_pratic_dias_semana[]" id="dias_semana1">
                    <label class="form-check-label" for="dias_semana1">Segunda-feira</label>
                  </div>

                  <div class="form-check form_solicita">
                    <input class="form-check-input form_solicita me-2" type="checkbox" name="cad_info_pratic_dias_semana[]" id="dias_semana2">
                    <label class="form-check-label" for="dias_semana2">Terça-feira</label>
                  </div>

                  <div class="form-check form_solicita">
                    <input class="form-check-input form_solicita me-2" type="checkbox" name="cad_info_pratic_dias_semana[]" id="dias_semana3">
                    <label class="form-check-label" for="dias_semana3">Quarta-feira</label>
                  </div>

                  <div class="form-check form_solicita">
                    <input class="form-check-input form_solicita me-2" type="checkbox" name="cad_info_pratic_dias_semana[]" id="dias_semana4">
                    <label class="form-check-label" for="dias_semana4">Quinta-feira</label>
                  </div>

                  <div class="form-check form_solicita">
                    <input class="form-check-input form_solicita me-2" type="checkbox" name="cad_info_pratic_dias_semana[]" id="dias_semana5">
                    <label class="form-check-label" for="dias_semana5">Sexta-feira</label>
                  </div>

                  <div class="form-check form_solicita">
                    <input class="form-check-input form_solicita me-2" type="checkbox" name="cad_info_pratic_dias_semana[]" id="dias_semana6">
                    <label class="form-check-label" for="dias_semana6">Sábado</label>
                  </div>
...
<script>
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    const subOpcoes = document.querySelectorAll('input[name="cad_info_pratic_material"]');
