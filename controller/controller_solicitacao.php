...
if ($_SERVER["REQUEST_METHOD"] == "POST" || $_SERVER["REQUEST_METHOD"] == "GET") {
  ...
  try {
    ...
    if ($solic_acao === 'cadastrar_1') {
      ...
      // SE 'STATUS_ETAPA' FOR DIFERENTE DE 3, QUER DIZER QUE O STATUS AINDA NÃO FOI ATUALIZADO
      if ($result['solic_etapa'] != 3) {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'Nova solicitação de espaço: ' . $solic_codigo; //TÍTULO DO E-MAIL

        $user_nome = $_SESSION['reservm_user_nome'];
        ...
        <tr style='background-color: #ffffff; text-align: center; color: #515050;  display: flex; justify-content: center; padding:10px 50px 0 50px; line-height: 23px;'>
          ...
          <p style='font-size: 1rem; font-weight: 400; margin: 0px 0px 20px 0px;'>
          Uma nova solicitação de espaço foi cadastrada por <strong>$user_nome</strong> e está aguardando sua análise. <br><br>
          Acesse o sistema através do botão abaixo para revisar e deferir/indeferir a solicitação. <br>
          Caso haja dúvidas ou necessidade de ajustes, entre em contato com o solicitante diretamente.
          </p>
