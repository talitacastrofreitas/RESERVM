  ...
  <div class="col-lg-8 col-xxl-6">
    <div class="card">
      <div class="card-header border-0 p-sm-4 p-3">
        ...
        $color_barra = isset($_GET['st']) ? ($color_map[$_GET['st']] ?? '100%') : null;
        ?>
          ...
          <div id="custom-progress-bar" class="progress-nav step_prop mb-4">
            ...
            <ul class="nav nav-pills progress-bar-tab custom-nav" role="tablist">
              <li class="nav-item" role="presentation">
                <button onclick="location.href='nova_solicitacao.php?st=1&i=<?= $_GET['i'] ?>'" class="nav-link rounded-pill active" data-progressbar="custom-progress-bar" id="pills-gen-info-tab" data-bs-toggle="pill" data-bs-target="#pills-gen-info" type="button" role="tab" aria-controls="pills-gen-info" aria-selected="true" data-position="0"><i class="fa-solid fa-check"></i></button>
              </li>
              <li class="nav-item" role="presentation">
                <button onclick="location.href='nova_solicitacao.php?st=2&i=<?= $_GET['i'] ?>'" class="nav-link rounded-pill <?= ($_GET['st'] >= 2) ? 'active' : ''; ?>" data-progressbar="custom-progress-bar" id="pills-success-tab" data-bs-toggle="pill" data-bs-target="#pills-success" type="button" role="tab" aria-controls="pills-success" aria-selected="false" data-position="1" tabindex="-1" <?php echo ($solic_etapa == 0) ? 'disabled' : ''; ?>><?php echo ($solic_etapa >= 2) ? '<i class="fa-solid fa-check"></i>' : '2'; ?></button>
              </li>
              <li class="nav-item" role="presentation">
                <button onclick="location.href='nova_solicitacao.php?st=3&i=<?= $_GET['i'] ?>'" class="nav-link rounded-pill <?= ($_GET['st'] >= 3) ? 'active' : ''; ?>" data-progressbar="custom-progress-bar" id="pills-success-tab" data-bs-toggle="pill" data-bs-target="#pills-success" type="button" role="tab" aria-controls="pills-success" aria-selected="false" data-position="2" tabindex="-1" <?php echo ($solic_etapa < 2) ? 'disabled' : ''; ?>><?php echo ($solic_etapa >= 3) ? '<i class="fa-solid fa-check"></i>' : '3'; ?></button>
              </li>
            </ul>
          </div>
