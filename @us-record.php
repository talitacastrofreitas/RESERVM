...
<div class="card card_user_registro">
  <div class="card-body">
    ...
    <form id="ValidaBotaoProgressPadrao" method="POST" action="controller/controller_usuarios.php?funcao=reg_user" class="needs-validation" novalidate>

      <div class="setup-content" id="step-1">

        <div class="mb-3">
          <label class="form-label">Sua matrícula <span>*</span></label>
          <input type="text" class="form-control text-uppercase" name="matricula" id="cad_admin_matricula" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="10" required>
